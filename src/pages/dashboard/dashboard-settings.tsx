    ...
    <div className="space-y-8 animate-fade-in-up">
      ...
      <Tabs defaultValue="profile" className="space-y-6">
        ...
        <TabsContent value="brand">
          <Card>
            <CardHeader>
              <CardTitle>Brand & Link Settings</CardTitle>
              <CardDescription>Customize your branded approval links</CardDescription>
            </CardHeader>
            <CardContent>Brand settings</CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="security">
          <Card>
            ...
            <CardContent>Security settings</CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="integrations">
          <Card>
            ...
            <CardContent>Integration settings</CardContent>
          </Card>
        </TabsContent>
      </Tabs>
    </div>
