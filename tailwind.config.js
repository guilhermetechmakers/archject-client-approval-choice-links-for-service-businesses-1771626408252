      ...
      typography: {
        archject: {
          css: {
            ...
            '--tw-prose-kbd-shadows': 'rgb(var(--foreground) / 0.1)',
            ...
            '--tw-prose-invert-body': 'rgb(var(--muted-foreground))',
            '--tw-prose-invert-headings': 'rgb(var(--foreground))',
            '--tw-prose-invert-lead': 'rgb(var(--muted-foreground))',
            '--tw-prose-invert-links': 'rgb(var(--primary))',
            '--tw-prose-invert-bold': 'rgb(var(--foreground))',
            '--tw-prose-invert-counters': 'rgb(var(--muted-foreground))',
            '--tw-prose-invert-bullets': 'rgb(var(--muted-foreground))',
            '--tw-prose-invert-hr': 'rgb(var(--border))',
            '--tw-prose-invert-quotes': 'rgb(var(--muted-foreground))',
            '--tw-prose-invert-quote-borders': 'rgb(var(--primary))',
            '--tw-prose-invert-captions': 'rgb(var(--muted-foreground))',
            '--tw-prose-invert-kbd': 'rgb(var(--foreground))',
            '--tw-prose-invert-kbd-shadows': 'rgb(var(--foreground) / 0.1)',
            '--tw-prose-invert-code': 'rgb(var(--foreground))',
            '--tw-prose-invert-pre-code': 'rgb(var(--foreground))',
            '--tw-prose-invert-pre-bg': 'rgb(var(--muted))',
